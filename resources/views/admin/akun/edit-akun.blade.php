                    ...
                    <div class="card shadow mb-4">
                        ...
                        <form action="{{ route('ubah-akun',$dtAkun->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="name" name="name" class="form-control" value="{{ $dtAkun->name }}" readonly>
                            </div>
                            <div class="form-group">
                                <label for="email" class="form-label">Email</label>
                                <input type="email" id="email" name="email" class="form-control" value="{{ $dtAkun->email }}" readonly>
                            </div>
                            <!--<div class="form-group">
