            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Transaksi User</h1>
                    </div>
                            ...
                            <table class="table table-bordered" style="display: block;
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $item->kota }}</td>
                                        <td>{{ $item->kode_pos }}</td>
                                        <td>{{ implode(', ', json_decode($item->qty)) }}</td>
                                        <td>{{ $item->ongkir->kd_ongkir }}</td>
                                        <td>Rp. {{ $item->total }}</td>
                                        <td>{{ $item->status }}</td>
                                        <td>{{ $item->resi }}</td>
                                        <td>
                                            <a href="{{ route('edit-order', $item->id) }}" class="btn btn-success btn-icon btn-sm" type="button"><span>Ubah</span></a>
                                            <a href="{{ route('hapus-order', $item->id) }}" class="btn btn-danger btn-icon btn-sm delete-confirm" type="button"><span>Hapus</span></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
